...
/**
 * DialogContent:
 * - mantém o botão de fechar SEMPRE visível no mobile (acompanha o scroll)
 * - reposicionado mais para baixo para não brigar com badges no topo da imagem
 * - evita barra “cinza”/header fixo
 */
